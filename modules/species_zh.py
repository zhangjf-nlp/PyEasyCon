"""
宝可梦英文→中文译名字典 (Gen 1-3, #0001-#0386)
来源: 神奇宝贝百科 (wiki.52poke.com) + tenlines species_en.txt
"""
_SPECIES_EN_TO_ZH = {
    ...
    "Qwilfish":"千针鱼","Scizor":"巨钳螳螂",
    "Shuckle":"壶壶","Heracross":"赫拉克罗斯",
    "Sneasel":"狃拉",
    ...
    "Smoochum":"迷唇娃","Elekid":"电击怪","Magby":"鸭嘴宝宝",
